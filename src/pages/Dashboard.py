...
if uploaded_file:
    ...
    st.session_state['report_images'].append(to_image(fig_bar, format="png"))
    ...
    st.session_state['report_images'].append(to_image(fig_pie, format="png"))
    ...
    if pd.api.types.is_numeric_dtype(df[df.columns[1]]):
        ...
        st.session_state['report_images'].append(to_image(fig_hist, format="png"))
    else:
    ...
    if st.checkbox("🔗 Sankey Diagram"):
        if validate_columns(3):
            ...
            st.session_state['report_images'].append(to_image(fig_sankey, format="png"))
        else:
    ...
    if st.checkbox("🌞 Sunburst Chart"):
        if validate_columns(3):
            ...
            st.session_state['report_images'].append(to_image(fig_sunburst, format="png"))
        else:
    ...
    if st.checkbox("📈 Line Chart"):
        if validate_columns(2) and pd.api.types.is_numeric_dtype(df[df.columns[1]]):
            ...
            st.session_state['report_images'].append(to_image(fig_line, format="png"))
        else:
    ...
    if st.checkbox("📊 Box Plot"):
        if validate_columns(2) and pd.api.types.is_numeric_dtype(df[df.columns[1]]):
            ...
            st.session_state['report_images'].append(to_image(fig_box, format="png"))
        else:
    ...
    if st.checkbox("📉 Area Chart"):
        if validate_columns(2) and pd.api.types.is_numeric_dtype(df[df.columns[1]]):
            ...
            st.session_state['report_images'].append(to_image(fig_area, format="png"))
        else:
    ...
    if st.checkbox("📊 Correlation Heatmap"):
        ...
        if numeric_df.shape[1] >= 2:
            ...
            st.session_state['report_images'].append(to_image(fig_heat, format="png"))
        else:
    ...
    if st.checkbox("🔍 Scatter Plot"):
        if validate_columns(2) and all(pd.api.types.is_numeric_dtype(df[col]) for col in df.columns[:2]):
            ...
            st.session_state['report_images'].append(to_image(fig_scatter, format="png"))
        else:
    ...
    if st.checkbox("📇 Violin Plot"):
        if validate_columns(2) and pd.api.types.is_numeric_dtype(df[df.columns[1]]):
            ...
            st.session_state['report_images'].append(to_image(fig_violin, format="png"))
        else:
        ...
        if validate_columns(2):
            if pd.api.types.is_numeric_dtype(df[df.columns[1]]):
                try:
                    ...
                    st.session_state['report_images'].append(to_image(fig_tree, format="png"))
